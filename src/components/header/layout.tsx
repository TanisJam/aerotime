...
export const Layout: FC<LayoutProps> = ({ children }) => {
  return (
    <header className="relative h-96 overflow-hidden ">
      <div className="absolute z-50 top-0 left-0 w-full h-full flex flex-col items-center pointer-events-none">
        <div className="text-4xl pointer-events-auto">{children}</div>
      </div>
